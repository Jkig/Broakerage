...
class Home extends StatefulWidget {
  ...
  class _HomeState extends State<Home> {
    ...
    Widget build(BuildContext context) {
      ...
      double cashval = globals.cash;

      List<StockData> stockList = globals.stocks;

      for (var j = 0; j < 12; j++) { // I hard coded in 12 here, don't lol
        stockList[j].quant = globals.quant1['${stockList[j].tickerInternal}'];
      }
      int accountIn = globals.account;
      int timeIn = globals.timeFrame;
      ...
      //define globals for profile:
      globals.total = totalVal;
      globals.cash = cashval;
                ...
                children: <Widget>[
                  ...
                  ButtonTheme(
                    ...
                    child: RaisedButton(
                      ...
                      color: accountIn == 0 ? Colors.blue[600] : Theme.of(context).accentColor,
                  ...
                  ButtonTheme(
                    ...
                    child: RaisedButton(
                      ...
                      color: accountIn == 1 ? Colors.blue[600] : Theme.of(context).accentColor,
                      child: Text('Indiv'),
                      padding: EdgeInsets.all(4.0),
                      //shape: CircleBorder(),
                      shape: RoundedRectangleBorder(
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  RaisedButton(
                    ...
                    color: timeIn == 0 ? Colors.blue[600] : Theme.of(context).accentColor,
                    child: Text('day'),
                  ...
                  RaisedButton(
                    ...
                    color: timeIn == 1 ? Colors.blue[600] : Theme.of(context).accentColor,
                    child: Text('1 W'),
                    padding: EdgeInsets.all(9.0),
                    shape: CircleBorder(),
                  ),
                  RaisedButton(
                    ...
                    color: timeIn == 2 ? Colors.blue[600] : Theme.of(context).accentColor,
                    child: Text('1 M'),
                    padding: EdgeInsets.all(9.0),
                    shape: CircleBorder(),
                  ),
                  RaisedButton(
                    ...
                    color: timeIn == 3 ? Colors.blue[600] : Theme.of(context).accentColor,
                    child: Text('3 M'),
                    padding: EdgeInsets.all(9.0),
                    shape: CircleBorder(),
                  ),
